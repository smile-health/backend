...
This directory organizes all architecture and design documentation for the SMILE Platform:

## Diagrams

- [System Context](diagrams/system-context.md)
- [Container Diagram](diagrams/containers.md)
...
- [Interaction Overview (Architecture Beta)](diagrams/architecture-beta.md)

## API & Integration

- [Authentication](authentication.md)
- [API Testing Guidelines](apitest.md)
- [Integration Samples](integration/)

## Database Models

- [Order Controller Models](databaseModels.md)
- [Transaction Controller Models](databaseModelsTransaction.md)
...
- [API Usage Examples](api-reference.md)
