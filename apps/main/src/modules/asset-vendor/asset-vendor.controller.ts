...
import { AssetVendorModule } from "./asset-vendor.module.js"
import { AssetVendorMiddleware } from "./asset-vendor.middleware.js"
import {
  UpdateAssetVendorParamSchema,
  GetAssetVendorParamSchema,
...
export class AssetVendorController extends BaseController {
  constructor(
    private readonly module: AssetVendorModule,
    private readonly middleware: AssetVendorMiddleware,
  ...
  getRoutes(): Hono {
    ...
    router.put(
      ...
      this.validateRequest("param", UpdateAssetVendorParamSchema),
    ...
    router.get(
      ...
      this.validateRequest("param", GetAssetVendorParamSchema),
