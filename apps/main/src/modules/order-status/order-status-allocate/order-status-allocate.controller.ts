...
import { OrderStatusAllocateMiddleware } from "./order-status-allocate.middleware.js"
import { OrderStatusAllocateModule } from "./order-status-allocate.module.js"
import { GetDetailOrderSchema } from "./order-status-allocate.schema.js"

export class OrderStatusAllocateController extends BaseController {
  constructor(
    private readonly middleware: OrderStatusAllocateMiddleware,
    private readonly module: OrderStatusAllocateModule,
