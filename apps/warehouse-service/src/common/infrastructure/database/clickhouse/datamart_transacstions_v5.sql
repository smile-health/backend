-- bronze_layer_v5.datamart_transactions_v5 definition

CREATE TABLE IF NOT EXISTS bronze_layer_v5.datamart_transactions_v5 on cluster '{cluster}'
(
    ...
    `transactions_activity_name` Nullable(String),

    `transactions_created_at` DateTime,

    `transactions_created_at_month` Nullable(Int64),

    `transactions_created_at_year` Nullable(Int64),
    ...
    `entities_province_name` Nullable(String),

    `entities_regency_name` Nullable(String),
    ...
    `dmm_unit_of_consumption_name` Nullable(String),

    `dmm_unit_of_distribution_name` Nullable(String),
