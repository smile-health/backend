...
export interface LoggerHistories2024 {
...
export interface UsersMobilePhoneBackup {
  id: Generated<number>;
  mobile_phone: string | null;
}
...
export interface WsDisposalTransactions {
  ...
  entity_id: number;
  id: Generated<number>;
  instruction_deadline: Date | null;
  instruction_note: string | null;
  instruction_status: Generated<string | null>;
  material_id: number;
...
export interface WsInstructionDisposalApprovals {
  ...
  deleted_by: number | null;
  id: Generated<number>;
  instruction_disposal_id: number;
  status: string;
  updated_at: Generated<Date>;
  updated_by: number | null;
}

export interface WsInstructionDisposalItems {
  allocated_qty: Generated<number | null>;
  available_qty: Generated<number | null>;
  batch_id: number;
  created_at: Generated<Date>;
  created_by: number | null;
  deleted_at: Date | null;
...
export interface WsTransactionLists {
  ...
  entity_material_activity_id: Generated<number | null>;
  entity_material_activity_max: Generated<number | null>;
  entity_material_activity_min: Generated<number | null>;
  entity_name: string | null;
  entity_tag_id: number | null;
...
export interface DB {
  ...
  locations: Locations;
  logger_histories_2024: LoggerHistories2024;
  ...
  users: Users;
  users_mobile_phone_backup: UsersMobilePhoneBackup;
  ...
  ws_instruction_disposal_approvals: WsInstructionDisposalApprovals;
  ws_instruction_disposal_items: WsInstructionDisposalItems;
