...
export class AddRemoveStockExcel {
  constructor() {}
  ...
  async generateReviewExport(
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("add-remove-stock.sheet.title")} ${c.var.t("common.overview")}`,
      filters,
      columns,
      data,
    }
  ...
  async generateMaterialExport(
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("add-remove-stock.sheet.title")} ${c.var.t("common.material")}`,
      filters,
      columns,
      data,
    }
  ...
  async generateEntityExport(
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("add-remove-stock.sheet.title")} ${c.var.t("common.entity")}`,
      filters,
      columns,
      data,
    }
  ...
  async generateLocationExport(
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("add-remove-stock.sheet.title")} ${c.var.t("common.location")}`,
      filters,
      columns,
      data,
    }
  ...
  async generateFilters(
    ...
    if (queryParams.transaction_type) {
      const typeLabel =
        queryParams.transaction_type === "7"
          ? c.var.t("transaction.type.add")
          : c.var.t("transaction.type.remove")
      filters.push({
