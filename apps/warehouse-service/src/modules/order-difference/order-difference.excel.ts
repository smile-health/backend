...
export class OrderDifferenceExcel {
  constructor(
  ...
  async generateReviewExport(
    ...
    reviewData: OrderDifferenceReviewResponse
  ) {
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("order-difference.sheet.title")} ${c.var.t("common.overview")}`,
      filters,
      columns,
      data,
    }
  ...
  async generateMaterialExport(
    c: Context,
    queryParams: OrderDifferenceQueryParams,
    materialData: OrderDifferencePaginatedResponse
  ) {
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("order-difference.sheet.title")} ${c.var.t("common.material")}`,
      filters,
      columns,
      data,
    }
  ...
  async generateEntityExport(
    c: Context,
    queryParams: OrderDifferenceQueryParams,
    entityData: OrderDifferencePaginatedResponse
  ) {
    // Transform data to tabular format for Excel with hierarchical structure
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("order-difference.sheet.title")} ${c.var.t("common.entity")}`,
      filters,
      columns,
      data,
    }
  ...
  async generateLocationExport(
    c: Context,
    queryParams: OrderDifferenceQueryParams,
    locationData: OrderDifferencePaginatedResponse
  ) {
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("order-difference.sheet.title")} ${c.var.t("common.location")}`,
      filters,
      columns,
      data,
    }
   ...
   */
  async generateFilters(c: Context, queryParams: OrderDifferenceQueryParams) {
    const {
      period,
      material_ids,
      activity_ids,
