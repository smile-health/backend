...
export class FillingStockExcel {
  constructor(
  ...
  async generateReviewExport(
    ...
    reviewData: FillingStockReviewResponse
  ) {
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("filling_stock.sheet.title")} ${c.var.t("common.overview")}`,
      filters,
      columns,
      data,
    }
  ...
  async generateMaterialExport(
    c: Context,
    queryParams: FillingStockQueryParams,
    materialData: FillingStockListResponse
  ) {
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("filling_stock.sheet.title")} ${c.var.t("common.material")}`,
      filters,
      columns,
      data,
    }
  ...
  async generateEntityExport(
    c: Context,
    queryParams: FillingStockQueryParams,
    entityData: FillingStockListResponse
  ) {
    // Transform data to tabular format for Excel with hierarchical structure
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("filling_stock.sheet.title")} ${c.var.t("common.entity")}`,
      filters,
      columns,
      data,
    }
  ...
  async generateEntityMaterialExport(
    c: Context,
    queryParams: FillingStockQueryParams,
    entityMaterialData: FillingStockEntityMaterialResponse
  ) {
    // Transform data to tabular format for Excel with hierarchical structure
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("filling_stock.sheet.title")} ${c.var.t("common.entity_material")}`,
      filters,
      columns,
      data,
    }
  ...
  async generateLocationExport(
    c: Context,
    queryParams: FillingStockQueryParams,
    locationData: FillingStockListResponse
  ) {
    ...
    const option: ExcelExportOption = {
      ...
      titleBar: `${c.var.t("filling_stock.sheet.title")} ${c.var.t("common.location")}`,
      filters,
      columns,
      data,
    }
   ...
   */
  async generateFilters(c: Context, queryParams: FillingStockQueryParams) {
    const {
      period,
      province_id,
      regency_id,
